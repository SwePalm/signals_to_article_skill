...
Built using the **AgentSkills** specification, treating prompts and scripts as micro-services.

## 📂 Structure

*   `skills/`: Contains all the modular skills (Harvest, Filter, Scenario, etc.).
...
3.  The agent will:
    *   Harvest signals (using `skills/signal_harvest`).
